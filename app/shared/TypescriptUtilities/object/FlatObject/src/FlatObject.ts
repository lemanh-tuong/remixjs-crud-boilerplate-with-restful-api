 ...
 *
 * @template T - The type of the source object with nested properties.
 * @param {T} sourceObject - The source object to be flattened.
 * @returns {Flattened} - A new type representing the flattened object.
 *
 * @example
 * ```typescript
 * type NestedUser = {
